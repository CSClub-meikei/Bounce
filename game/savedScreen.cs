...
namespace Bounce
{
    class savedScreen : Screen
    {
        ...
        public savedScreen(Game1 game, Screen screen, int sx = 0, int sy = 0) : base(game, sx, sy)
        {
            title = new GraphicalGameObject(game, this, Assets.graphics.game.saved, 320, 100, 640, 200);
            title.addAnimator(2);
