...
namespace Bounce
{
    class thorn:GraphicalGameObject
    {
        public thorn(Game1 game, Screen screen, Texture2D Texture, float x, float y, float width, float height) : base(game, screen, Texture, x, y, width, height)
        {
