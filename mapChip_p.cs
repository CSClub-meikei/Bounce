...
namespace Bounce
{
    class mapChip_p:GraphicalGameObject
    {
        const int size = 40;
        public int fx, fy;
        public int rx, ry;
        ...
        public mapChip_p(Game1 game, Screen screen, Texture2D Texture,int mode,int rotate,int drawMode, float x, float y, float width, float height) : base(game, screen, Texture, x, y, width, height)
        {
            this.mode = mode;
            this.rotate = rotate;
